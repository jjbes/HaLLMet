...
export default ({ content, href, highlightedCfi, setHighlightedCfi }: QuoteProps) => {
    ...
    return (
    <div id={href} className="relative h-full p-4 text-center text-gray-700 bg-white border-l-4 border-l-blue-500">
        <blockquote className={`p-4 border-l-4 ${href==highlightedCfi?"border-yellow-300 bg-yellow-50":"border-slate-300 bg-slate-50"} cursor-pointer`} onClick={() => {eventClick(href)}}>
